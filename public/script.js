document.addEventListener('DOMContentLoaded', () => {
  ...
  const loadArtsButton = document.getElementById('loadArtsButton');

  // Загружаем изображения при загрузке страницы и при нажатии кнопки
  ...
  // Добавляем обработчик событий для кнопки "Загрузить изображения"
  loadArtsButton.addEventListener('click', loadArts);
